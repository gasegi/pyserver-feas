...
router = APIRouter()
router.add_route("/view_session", view_session)
router.add_route("/update_session", update_session, methods=["POST"])
router.add_route("/clear_session", clear_session, methods=["POST"])
